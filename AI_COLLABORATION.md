...
| M-007 | Alta | Reconstruir `/products/cata` como página informativa simple y completar Privacidad, Términos y FAQ de CATA | Codex | Terminada | app/products/cata/**, components/layout/site-header.tsx | 2026-08-01 |
| M-008 | Alta | Rediseñar la homepage con dirección editorial premium, movimiento accesible y CATA como caso destacado | Codex | Terminada | app/(bare)/page.tsx, app/globals.css, components/sections/monarka-home-sections.tsx, components/effects/** | 2026-08-03 |
...
| D-005 | 2026-08-01 | Simplificar `/products/cata` a una página informativa editorial, sin demo interactiva, con estado del producto y acceso directo a privacidad, términos, FAQ, soporte y eliminación de cuenta. | Rubén solicitó limpiar y rehacer la sección CATA desde cero como página de información. | Rubén |
| D-006 | 2026-08-03 | La homepage adopta una dirección editorial oscura y project-first: tipografía de gran escala, manifiesto en movimiento, CATA como caso principal, capacidades en lista y CTA directo; el diagrama anterior deja de formar parte de la ruta pública. | La composición anterior repetía tarjetas informativas y no alcanzaba la calidad ni jerarquía de las referencias aprobadas. | Rubén |
...
- Reemplazó la propuesta clara y basada en tarjetas por una homepage editorial oscura con una jerarquía visual propia de Monarka.
- Construyó un hero tipográfico responsive, manifiesto animado, caso destacado de CATA con captura real, lista de capacidades, bloque institucional y cierre de contacto.
- Conservó Lenis, cursor personalizado, scroll reveals y botones magnéticos, con degradación para `prefers-reduced-motion`.
- Retiró el diagrama esquemático de la composición pública sin borrar su componente ni otros cambios existentes.
- Verificación: `npm run lint` limpio, `npm run build` exitoso y export estático generado (9 rutas).

### 2026-08-01 — Codex

- Reconstruyó `/products/cata` como una página informativa responsive y accesible, conservando la identidad terracota/parchment de CATA.
- Retiró de la ruta principal la landing promocional y la demo interactiva; agregó información esencial, estado de desarrollo y un centro de recursos.
- Sustituyó los placeholders de FAQ y Términos por contenido navegable, y publicó la Política de Privacidad directamente dentro del tema CATA.
- Ajustó el enlace del logotipo CATA para volver al inicio del producto.
- Verificación: `npm run lint` limpio y `npm run build` exitoso; 24 páginas estáticas generadas.
